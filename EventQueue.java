class Event {
    ...
    // Implementation of Event Management using Queue data structure
    int maxSize;
    String EventArray[];
    int front;
    int rear;
    ...
    public void completedEvent() {
        if (count == 0) {
            System.out.println("No Event is available to complete.");
        } else {
    ...
    public void pendingEvent() {
        if (count == 0) {
            System.out.println("No Event is Organized.");
        } else {
    ...
    public void cancelEvent(String eventName) {
        ...
        // Shift elements to remove the event
        int i = indexToRemove;
        while (i != rear) {
        ...
        // Clear the last element and update rear
...
public class EventQueue {
    public static void main(String args[]) {
        ...
        e.addEvent("Playing");
        e.addEvent("Archery"); // exceeds limit
        e.pendingEvent();
        e.completedEvent();
        e.pendingEvent();
